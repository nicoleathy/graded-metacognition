...
We extend [ESMA](https://arxiv.org/abs/2602.02605) with graded confidence probes and rewards, enabling LLMs to express calibrated multi-level confidence rather than binary Yes/No self-knowledge.
